                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-4">
                            ...
                            <div class="flex flex-wrap gap-2 justify-end">
                                ...
                                @if(in_array(Auth::user()->role?->name, ['Administrador', 'Almacenista']))
                                    <a href="{{ route('consumables.import') }}" class="inline-flex items-center px-4 py-2 bg-yellow-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-yellow-700 transition">
                                    ...
                                    <td class="px-4 py-4 text-right whitespace-nowrap">
                                        <div class="flex justify-end items-center gap-3">
                                            ...
                                            @if(in_array(Auth::user()->role?->name, ['Administrador', 'Almacenista']))
                                                ...
                                                <a href="{{ route('consumables.label', $item) }}" class="text-purple-600 hover:text-purple-900 text-sm font-medium flex items-center" title="Imprimir Etiqueta" target="_blank">
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17h6m-6-4h6"></path></svg>
                                                    Etiqueta
                                                </a>
                                            @endif
                                        </div>
