    ...
    <div class="py-12" x-data="{ ...hazmatForm(), submitting: false }">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 relative">
            ...
            <div x-show="showSuccess" 
                 ...
                 class="fixed top-20 right-5 z-50 max-w-sm w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden border-l-4 border-green-500"
                 style="display: none;">
                <div class="p-4">
            ...
            <div class="bg-indigo-50 dark:bg-indigo-900 p-6 rounded-lg mb-6 border border-indigo-200 dark:border-indigo-700 shadow-sm">
                <h3 class="text-lg font-bold text-indigo-800 dark:text-indigo-200 mb-2 flex items-center">
                    ...
                    Completar informacion de forma automatica.
                </h3>
                    ...
                    <form method="POST" action="{{ route('hazmat.store') }}" enctype="multipart/form-data" @submit="submitting = true">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select id="signal_word" name="signal_word" x-model="form.signal_word" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 rounded-md shadow-sm font-bold" required>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input id="hds_file" type="file" name="hds_file" accept=".pdf" class="block mt-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                </div>
                                <div>
                                    <x-input-label for="product_image" :value="__('Foto del Producto')" />
                                    <input id="product_image" type="file" name="product_image" accept="image/*" class="block mt-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                </div>
                            </div>
                        </div>
            ...
            return {
                ...
                async analyzePdf() {
                    ...
                    try {
                        ...
                        console.error(error);
                        this.errorMessage = 'Error al analizar: ' + (error.response?.data?.error || error.message);
                    } finally {
                        this.loading = false;
                    }
                }
