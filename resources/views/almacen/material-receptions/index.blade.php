                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4">
                                        @if($reception->quality_certificate) <span class="text-green-600 font-bold">SI</span> @else <span class="text-red-600">NO</span> @endif
                                    </td>
                                    ...
                                    @else
                                        ...
                                        <td class="px-6 py-4 text-right whitespace-nowrap">
                                            <a href="{{ route('material-receptions.pdf', $reception) }}" target="_blank" class="font-medium text-green-600 hover:underline mr-3">PDF</a>
                                            @if(Auth::user()->role?->name === 'Administrador')
                                                <a href="{{ route('material-receptions.edit', $reception) }}" class="font-medium text-indigo-600 hover:underline mr-3">Editar</a>
                                                <button @click="showCancelModal = true; cancelUrl = '{{ route('material-receptions.destroy', $reception) }}'" class="font-medium text-red-600 hover:underline">Cancelar</button>
                                            @endif
                                        </td>
                                    @endif
                                </tr>
